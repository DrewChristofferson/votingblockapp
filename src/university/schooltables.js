            ...
            <>
                ...
                <Switch>
                    <Route path={`${match.path}/${URL_PARAM_PROFESSORS}`}>
                        <ProfessorTable isSearched={props.isSearched} initPageNum={props.initPageNum} savedNextToken={props.savedNextTokenProfessor} updateFinishedLoading={props.updateLoadingProfessors} isFinishedLoading={props.isFinishedLoadingProfs} userid={userid} colleges={props.colleges} professors={getProfessors()} updateScore={props.updateScore} getRatings={props.getRatings}  createRating={props.createRating} nextPage={props.nextPage} previousPage={props.previousPage} pageNum={props.pageNum} handleChangeSearch={props.handleChangeSearch} handleChangeToggle={handleChangeToggle} CATEGORIES={CATEGORIES} categoryValue={props.categoryValue} />
                    </Route>
                    <Route path={`${match.path}/${URL_PARAM_COURSES}`}>
                        <CourseTable isSearched={props.isSearched} initPageNum={props.initPageNum} savedNextToken={props.savedNextTokenCourse} updateFinishedLoading={props.updateLoadingCourses} isFinishedLoading={props.isFinishedLoadingCourses} userid={userid}  colleges={props.colleges} courses={getNewCourses()} userRatings={props.userRatings} updateScore={props.updateScore} getRatings={props.getRatings}  createRating={props.createRating} nextPage={props.nextPage} previousPage={props.previousPage} pageNum={props.pageNum} handleChangeSearch={props.handleChangeSearch} handleChangeToggle={handleChangeToggle} CATEGORIES={CATEGORIES} categoryValue={props.categoryValue} />
                    </Route>
                </Switch>
            </>
        )
