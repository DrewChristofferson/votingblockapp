...
`;
export const createCourseComment = /* GraphQL */ `
  mutation CreateCourseComment(
    $input: CreateCourseCommentInput!
    $condition: ModelCourseCommentConditionInput
  ) {
    createCourseComment(input: $input, condition: $condition) {
      id
      courseID
      content
      createdAt
