...
`;
export const ratingsByUserAndCategory = /* GraphQL */ `
  query RatingsByUserAndCategory (
    $userID: String
    $category: ModelIDKeyConditionInput
    $sortDirection: ModelSortDirection
    $filter: ModelRatingFilterInput
    $limit: Int
    $nextToken: String
...
`;
export const ratingsByContent = /* GraphQL */ `
  query RatingsByContent(
    $type: String
    $contentID: ModelIDKeyConditionInput
    $sortDirection: ModelSortDirection
    $filter: ModelRatingFilterInput
...
`;
export const ratingsByCategory = /* GraphQL */ `
...
`;
export const coursesByGE = /* GraphQL */ `
  query CoursesByGE(
    $type: String
    $isGeneralStr: ModelStringKeyConditionInput
    $sortDirection: ModelSortDirection
    $filter: ModelCourseFilterInput
    $limit: Int
    $nextToken: String
...
`;
export const professorsByName = /* GraphQL */ `
  query ProfessorsByName(
    $type: String
    $name: ModelStringKeyConditionInput
    $sortDirection: ModelSortDirection
    $filter: ModelProfessorFilterInput
