...
const initialFormState = { name: '', code: '', score: '0', departmentID: '', numCredits: '', isGeneral: 'False', type: 'Course' }
...
function CreateCourseModal(props) {
    ...
    async function getData() {
      ...
      let schoolsFromAPI;
      try {
        apiData = await API.graphql({ query: listSchools, authMode: 'API_KEY' });
        ...
        if(schoolsFromAPI[0] && schoolsFromAPI[0].departments.items[0]){
